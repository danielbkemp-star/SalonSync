  ...
  return (
    <div className={cn('rounded-xl bg-gray-900 border border-gray-800 p-4', className)}>
      <div className="flex items-center justify-between mb-4">
        ...
        <Link to="/appointments" className="text-sm text-purple-400 hover:text-purple-300">
          View all
        </Link>
      </div>
        ...
        {appointments.map((apt) => (
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-gray-200">{apt.clientName}</span>
            </div>
            <div className="flex items-center gap-2">
              <Scissors className="h-4 w-4 text-gray-500" />
              <span className="text-gray-400 text-sm">{apt.service}</span>
            </div>
          </div>
        ))}
